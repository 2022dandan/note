    ...
    <div>
      ...
      <el-card :body-style="{ padding: '0px' }" style="height:170px; position: relative;">
        <div style="padding: 14px; ">
          ...
          <div style="margin: 5px 0 0 15px"><span style="font-weight:bolder;font-size: larger;">卡片详情：</span><span style="word-wrap:break-word; ">{{originForm.card_content}}</span></div>
          <div class="note-edit">
